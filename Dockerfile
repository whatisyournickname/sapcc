...
# General information
################################################################
LABEL sapcc.version="2.11.2"
LABEL sapcc.sapjvm.version="8.1.041"
LABEL sapcc.vendor="whatisyournickname"
LABEL sapcc.name="SAP CloudConnector"
...
RUN wget --no-check-certificate --no-cookies --header "Cookie: eula_3_1_agreed=tools.hana.ondemand.com/developer-license-3_1.txt; path=/;" -S https://tools.hana.ondemand.com/additional/sapcc-2.11.2-linux-x64.zip && \
    wget --no-check-certificate --no-cookies --header "Cookie: eula_3_1_agreed=tools.hana.ondemand.com/developer-license-3_1.txt; path=/;" -S https://tools.hana.ondemand.com/additional/sapjvm-8.1.042-linux-x64.rpm && \
    unzip sapcc-2.11.2-linux-x64.zip && \
    rpm -i sapjvm-8.1.042-linux-x64.rpm && rpm -i com.sap.scc-ui-2.11.2-7.x86_64.rpm
...
# downloaded from https://tools.hana.ondemand.com/#cloud, i.e. sapcc-2.11.2-windows-x64.zip, sapcc-2.11.2-linux-x64.tar.gz, sapcc-2.11.2-macosx-x64.tar.gz
